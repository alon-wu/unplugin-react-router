...
| [File conventions](docs/en/file-conventions.md) | The full file → route mapping table, layouts, groups, dynamic/splat segments, edge cases and errors |
| [Route modules](docs/en/route-modules.md) | The page-module contract, generated lazy loader, supported exports and typing guidance |
...
| [Architecture](docs/en/architecture.md) | Motivation, module map, route-tree model, codegen, virtual module, dev/HMR behaviour, comparison with unplugin-vue-router, known limitations & roadmap |
...
end-to-end suite; see [Testing](docs/en/testing.md). Read the
